...
if __name__ == "__main__":
    ...
    spark = SparkSession.builder \
        .appName('Dinesh_Madiraju_cs643851_wine_prediction') \
        .getOrCreate()
    ...
    if len(sys.argv) > 3:
        ...
        input_path = "s3://pa2wine/TrainingDataset.csv"
        valid_path = "s3://pa2wine/ValidationDataset.csv"
        output_path="s3://pa2wine/testmodel.model"
    ...
    print('Test Accuracy of wine prediction model = ', accuracy)
    metrics = MulticlassMetrics(results.rdd.map(tuple))
    print('Weighted score of wine prediction model = ', metrics.weightedFMeasure())
